...
import {
  Rocket, // Using Rocket icon for this service
  ArrowRight,
  Check,
  Sparkles,
} from 'lucide-react';
...
export default function SeoOptimizationPage() {
  ...
  const service = {
    id: 'seo',
    icon: Rocket,
    color: 'from-orange-500 to-red-600', // Color from services.tsx
    image: imagePaths.services.seo,
    title: t(`services.seo.title`),
    description: t(`services.seo.description`),
    features: t.raw(`services.seo.features`) as string[],
    benefits: t.raw(`services.seo.benefits`) as { title: string; items: string[] } | undefined,
    process: t.raw(`services.seo.process`) as { title: string; items: string[] } | undefined,
  };
    ...
    <>
      ...
      <section ref={headerRef} className="section-padding hero-pattern">
        <div className="container-custom">
          <div className="seo-header text-center max-w-3xl mx-auto">
      ...
      <section className="section-padding bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--accent))]">
        <div className="container-custom text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Let&apos;s craft an SEO strategy that drives organic traffic and converts visitors into customers.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/services/seo">{t('cta.learnMore')}</Link>
            </Button>
          </div>
        </div>
      </section>
