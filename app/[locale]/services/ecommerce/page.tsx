...
import {
  ShoppingCart, // Using ShoppingCart icon for this service
  ArrowRight,
  Check,
  Sparkles,
} from 'lucide-react';
...
export default function EcommerceSolutionsPage() {
  ...
  const service = {
    id: 'ecommerce',
    icon: ShoppingCart,
    color: 'from-orange-500 to-red-600', // Adjusted color for ecommerce
    image: imagePaths.services.seo, // Placeholder image for now, can be changed later
    title: t(`services.ecommerce.title`),
    description: t(`services.ecommerce.description`),
    features: t.raw(`services.ecommerce.features`) as string[],
    benefits: t.raw(`services.ecommerce.benefits`) as { title: string; items: string[] } | undefined,
    process: t.raw(`services.ecommerce.process`) as { title: string; items: string[] } | undefined,
  };
    ...
    <>
      ...
      <section ref={headerRef} className="section-padding hero-pattern">
        <div className="container-custom">
          <div className="ecommerce-header text-center max-w-3xl mx-auto">
                  ...
                  {service.process && Object.keys(service.process).length > 0 && (
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="process">
                        ...
                        <AccordionContent>
                          <ol className="relative border-l border-dashed border-[hsl(var(--border))] ml-3 mt-4">
                            {service.process.items.map((item, i) => (
                              <li key={i} className="pl-8 py-2">
        ...
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/services/ecommerce">{t('cta.learnMore')}</Link>
            </Button>
          </div>
        </div>
      </section>
