...
import {
  Layers, // Using Layers icon for this service
  ArrowRight,
  Check,
  Sparkles,
} from 'lucide-react';
...
export default function HostingSolutionsPage() {
  ...
  const service = {
    id: 'hosting',
    icon: Layers,
    color: 'from-violet-500 to-purple-600', // Color from services.tsx
    ...
    benefits: t.raw(`services.hosting.benefits`) as { title: string; items: string[] } | undefined,
    process: t.raw(`services.hosting.process`) as { title: string; items: string[] } | undefined,
  };
    ...
    <>
      ...
      <section ref={headerRef} className="section-padding hero-pattern">
        <div className="container-custom">
          <div className="hosting-header text-center max-w-3xl mx-auto">
      ...
      <section ref={serviceDetailRef} className="section-padding">
        <div className="container-custom">
          <div className="hosting-detail-content space-y-12">
      ...
      <section className="section-padding bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--accent))]">
        <div className="container-custom text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Experience peace of mind with our optimized and fully managed hosting solutions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/services/hosting">{t('cta.learnMore')}</Link>
            </Button>
          </div>
        </div>
      </section>
